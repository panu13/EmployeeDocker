...
namespace EmployeeAttendanceSystem.Services.EmployeeServices
{
    public class EmployeeService : IEmployeeService
    {
      ...
      {
          new Employee{EmployeeId = "01" , EmployeeName = "Harshal", EmployeeGender = "M", EmployeeEmail = "abc@gmail.com", EmployeeContact = 9988776655, EmployeeUsername = "Harsh", EmployeePassword = "Harsh@123"},
          new Employee {EmployeeId = "02" , EmployeeName = "Pranali", EmployeeGender = "F", EmployeeEmail = "def@gmail.com", EmployeeContact = 9988446633, EmployeeUsername = "Panu", EmployeePassword = "Panu@123"}
